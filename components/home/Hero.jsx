...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,_rgba(13,148,136,0.10),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(245,158,11,0.08),_transparent_30%)]" />
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-teal-700 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-teal-200 transition hover:bg-teal-800"
              >
                Start Practicing
                <ArrowRight size={18} />
              </Link>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 h-32 w-32 rounded-full bg-amber-100 blur-3xl" />

            <div className="relative rounded-[28px] border border-slate-200 bg-white p-4 shadow-2xl shadow-slate-200/70 sm:p-6">
              <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4 sm:p-5">
                ...
                <div className="mt-5 h-2 w-full overflow-hidden rounded-full bg-slate-200">
                  <div className="h-full w-[46%] rounded-full bg-teal-700" />
                </div>
                ...
                <div className="mt-6 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    <div className="rounded-2xl border border-teal-700 bg-teal-50 px-4 py-3 text-sm font-semibold text-teal-800 shadow-sm">
                      B. Ointment
                    </div>
